      ...
      <div className="mainDiv">
        ...
        <div className="depts my-1">
          <span className="label-clr">
            <i class="bi bi-tag-fill"></i> {data.category}
          </span>
        </div>

        <h5 className="dept-head"><i class="bi bi-mortarboard"></i> {data.department}</h5>
        ...
        <div className="px-3 align-items-center card-footerCC d-flex justify-content-between">
          <div className="left">
            <h6 className="mt-2 location" style={{ fontSize: 16 }}>
              <i class="bi bi-geo-alt-fill" style={{ color: "#6d23e4" }}></i>{" "}
              {data.location}
            </h6>
